...
namespace Yazilim_Sinama
{
    public partial class Form_Sinav : Form
    {
        ...
        SqlConnection bag = new SqlConnection(@"Data Source=.;Initial Catalog=YazilimSinamaVeriTabani; Integrated Security=True");
        ...
        private void Form_Sinav_Load(object sender, EventArgs e)
        {
            ...
            /*foreach (Soru i in Sorular) Deneme
            {
                listBox1.Items.Add("Soru "+i.So+" Doğru Cevap "+i.cd);
            }*/
        }
